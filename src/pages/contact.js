    ...
    return (
      <Layout>
        <div className="content-section">
          ...
          <GoogleMap API_KEY={ this.props.data.site.siteMetadata.mapKey } PLACE_ID={ this.props.data.site.siteMetadata.placeId } />
          <section className="section">
            <div className="container">
              <h1 className="title is-size-4"> Contact Us </h1>
              <div className="columns">
                <div className="column is-two-thirds">
                  <FormContact section="Contact Us" manufacturers={ manufacturers } recaptchaKey={ siteMetadata.recaptchaKey } />
                </div>
